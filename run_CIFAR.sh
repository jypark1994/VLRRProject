...
CUDA_VISIBLE_DEVICES=0,1 python3 pretrainer_CIFAR.py --down_scale 1 --interpolate --model_name resnet34 --batch_size 64 --num_workers 8 --pretrained --multi_gpu > ./models/CIFAR10/resnet34_x1_pt.txt;

CUDA_VISIBLE_DEVICES=0,1 python3 pretrainer_CIFAR.py --down_scale 1 --interpolate --model_name resnet50 --batch_size 64 --num_workers 8 --pretrained --multi_gpu > ./models/CIFAR10/resnet50_x1_pt.txt;
