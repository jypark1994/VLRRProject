...
def get_model(model, data_name):
    if data_name == 'cifar10':  # 32x32x3 input
        ...
        net.fc = nn.Linear(net.in_features, args.num_classes)
    return net
...
net_t = get_model(teacher_name, data_name)
...
net_s = get_model(student_name, data_name)
